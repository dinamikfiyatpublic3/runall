...
def trigger_group_0():
    workflows_group_0 = [
        {"workflow_owner": "dinamikfiyatpublic", "workflow_repo": "anlik_guncel", "workflow_name": "supabase_timestamp_update.yml"}
    ]
...
def trigger_group_2():
    workflows_group_2 = [
        {"workflow_owner": "dinamikfiyatpublic", "workflow_repo": "anlik_guncel", "workflow_name": "supabase_table_yap.yml"}
    ]
