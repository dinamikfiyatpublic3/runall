...
def trigger_workflow(workflow_name):
    response = requests.post(
        f"https://api.github.com/repos/dinamikfiyatpublic3/anlik_guncel/actions/workflows/{workflow_name}/dispatches",
        json={"ref": "main"},
...
def check_running_workflows():
    ...
    response = requests.get(
        "https://api.github.com/repos/dinamikfiyatpublic3/anlik_guncel/actions/runs",
        headers={"Authorization": f"token {github_token}"}
    )
