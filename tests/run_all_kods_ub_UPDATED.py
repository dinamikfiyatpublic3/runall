...
def trigger_group_0():
    workflows_group_0 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "supabase_timestamp_update_ub.yml"}
    ]
...
def trigger_group_1():
    workflows_group_1 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "otomatik_ana_api_scrape_matrix_ub.yml"}     
    ]
...
def trigger_group_1_1():
    workflows_group_1_1 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "concurrent_run_ana_api_matrix_kalanlar_ub.yml"}     
    ]
    logging.info("Grup 1_1 Workflow'ları başlatılıyor...")
    threads = []
...
def trigger_group_2():
    workflows_group_2 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "supabase_table_yap_ub.yml"},
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "concurrent_run_api_best_sales_ub.yml"},
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "scrape_api_urunlerim_rakipli_kalan_monitor_ub.yml"}
    ]
...
def trigger_group_3_1_1():
    workflows_group_3_1_1 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "supabase_update_view_yeni_table_filter_ub.yml"}
    ]
...
def trigger_group_3_2():
    workflows_group_3_2 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "otomatik_api_scrape_matrix_ub_0_restart.yml"}
...
def trigger_group_4():
    workflows_group_4 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "scrape_api_markalarım_rakipli_ub.yml"},
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "scrape_api_urunlerim_rakipli_kalan_monitor_ikinci_ub.yml"},
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "concurrent_run_idefix_eksik_urun_api_matrix_ub.yml"}
    ]
...
def trigger_group_5():
    workflows_group_5 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "supabase_run_ub.yml"}
    ]
...
def trigger_group_6():
    workflows_group_6 = [
        {"workflow_owner": "dinamikfiyatpublic3", "workflow_repo": "workflows-public", "workflow_name": "supabase_mail_send.yml"}
    ]
